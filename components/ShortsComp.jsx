    ...
    <div>
      <div className='flex w-auto ml-2'>        
        <div className='p-0.5 rounded-xl'>
            <Image src='/assets/images/DSC_0914.jpeg' alt='VEST-1' width={400} height={250} />
        </div>
        <div className='p-0.5 rounded-xl'>
            <Image src='/assets/images/DSC_0915.jpeg' alt='VEST-2' width={400} height={250} />
        </div>
        <div className='p-0.5 rounded-xl'>
            <Image src='/assets/images/DSC_0914.jpeg' alt='VEST-3' width={400} height={250} />
        </div>
